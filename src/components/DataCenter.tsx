    ...
    <>
      <section className="rounded-[28px] bg-card p-5 shadow-[0_8px_24px_rgba(28,25,23,0.06)]">
        ...
        <p className="mt-2 text-sm text-muted">
          Progress stays on this device. Export includes habits, check-ins,
          today&apos;s Clock In, and Hide September. Export before you clear
          browser data.
        </p>
      ...
      <GetTheApp onExportBackup={onExport} />
    </>
  )
}
